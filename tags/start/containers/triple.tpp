...
stlplus::triple<T1,T2,T3>::triple(void) :
  first(), second(), third()
{
}

template<typename T1, typename T2, typename T3>
stlplus::triple<T1,T2,T3>::triple(const T1& p1, const T2& p2, const T3& p3) :
  first(p1), second(p2), third(p3)
{
}

template<typename T1, typename T2, typename T3>
stlplus::triple<T1,T2,T3>::triple(const stlplus::triple<T1,T2,T3>& t2) :
...
template<typename T1, typename T2, typename T3>
stlplus::triple<T1,T2,T3> stlplus::make_triple(const T1& first, const T2& second, const T3& third)
{
  return stlplus::triple<T1,T2,T3>(first,second,third);
}
