...
void stlplus::dump_set(stlplus::dump_context& context, const std::set<K,P>& data, D dump_fn)
...
void stlplus::restore_set(stlplus::restore_context& context, std::set<K,P>& data, R restore_fn)
