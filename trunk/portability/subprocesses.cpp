...
stlplus::arg_vector::arg_vector (void)
{
  v = 0;
}

stlplus::arg_vector::arg_vector (const stlplus::arg_vector& a)
{
  v = 0;
  *this = a;
}

stlplus::arg_vector::arg_vector (char** a)
{
  v = 0;
  *this = a;
}

stlplus::arg_vector::arg_vector (const std::string& command)
{
  v = 0;
  *this = command;
}

stlplus::arg_vector::arg_vector (const char* command)
{
  v = 0;
  *this = command;
}
...
stlplus::arg_vector& stlplus::arg_vector::operator = (const stlplus::arg_vector& a)
{
  return *this = a.v;
}

stlplus::arg_vector& stlplus::arg_vector::operator = (char** a)
{
  clear();
...
stlplus::arg_vector& stlplus::arg_vector::operator = (const std::string& command)
{
  clear();
...
stlplus::arg_vector& stlplus::arg_vector::operator = (const char* command)
{
  return operator = (std::string(command));
}

stlplus::arg_vector& stlplus::arg_vector::operator += (const std::string& str)
{
  insert(size(), str);
  return *this;
}
...
void stlplus::arg_vector::insert (unsigned index, const std::string& str) throw(std::out_of_range)
{
  if (index > size()) throw std::out_of_range("stlplus::arg_vector::insert");
...
void stlplus::arg_vector::clear (unsigned index) throw(std::out_of_range)
{
  if (index >= size()) throw std::out_of_range("stlplus::arg_vector::clear");
...
void stlplus::arg_vector::clear(void)
{
  if (v)
  {
...
unsigned stlplus::arg_vector::size (void) const
{
  unsigned i = 0;
  if (v) while (v[i]) i++;
  return i;
...
stlplus::arg_vector::operator char** (void) const
{
  return v;
}

char** stlplus::arg_vector::argv (void) const
{
  return v;
}

char* stlplus::arg_vector::operator [] (unsigned index) const throw(std::out_of_range)
{
  if (index >= size()) throw std::out_of_range("stlplus::arg_vector::operator[]");
  return v[index];
}

char* stlplus::arg_vector::argv0 (void) const throw(std::out_of_range)
{
  return operator [] (0);
}

std::string stlplus::arg_vector::image (void) const
{
  std::string result;
...
stlplus::env_vector::env_vector(void)
{
...
stlplus::env_vector::env_vector (const stlplus::env_vector& a)
{
  v = 0;
  *this = a;
}
...
stlplus::env_vector& stlplus::env_vector::operator = (const stlplus::env_vector& a)
{
  clear();
  v = envp_copy(a.v);
  return *this;
...
void stlplus::env_vector::clear(void)
{
  envp_clear(v);
}
...
void stlplus::env_vector::add(const std::string& name, const std::string& value)
{
...
bool stlplus::env_vector::remove (const std::string& name)
{
  bool result = false;
...
std::string stlplus::env_vector::operator [] (const std::string& name) const
{
  return get(name);
}
...
std::string stlplus::env_vector::get (const std::string& name) const
{
  unsigned i = 0;
  while(v[i])
  {
...
unsigned stlplus::env_vector::size (void) const
{
  unsigned i = 0;
  unsigned offset = 0;
  while(v[offset])
...
std::pair<std::string,std::string> stlplus::env_vector::operator [] (unsigned index) const throw(std::out_of_range)
{
  return get(index);
}

std::pair<std::string,std::string> stlplus::env_vector::get (unsigned index) const throw(std::out_of_range)
{
  if (index >= size()) throw std::out_of_range("stlplus::arg_vector::get");
  unsigned j = 0;
...
ENVIRON_TYPE stlplus::env_vector::envp (void) const
{
  return v;
}
...
stlplus::subprocess::subprocess(void)
{
  pid.hProcess = 0;
  child_in = 0;
  child_out = 0;
...
void stlplus::subprocess::add_variable(const std::string& name, const std::string& value)
{
  env.add(name, value);
}

bool stlplus::subprocess::remove_variable(const std::string& name)
{
...
bool stlplus::subprocess::callback(void)
{
  return true;
}
...
bool stlplus::subprocess::kill (void)
{
...
int stlplus::subprocess::write_stdin (std::string& buffer)
{
...
int stlplus::subprocess::read_stdout (std::string& buffer)
{
...
int stlplus::subprocess::read_stderr(std::string& buffer)
{
...
void stlplus::subprocess::close_stdin (void)
{
  if (child_in)
  {
...
void stlplus::subprocess::close_stdout (void)
{
  if (child_out)
  {
...
void stlplus::subprocess::close_stderr (void)
{
  if (child_err)
  {
...
bool stlplus::subprocess::error(void) const
{
  return err != 0;
}

int stlplus::subprocess::error_number(void) const
{
  return err;
}
...
std::string stlplus::subprocess::error_text(void) const
{
...
int stlplus::subprocess::exit_status(void) const
{
  return status;
}
...
stlplus::backtick_subprocess::backtick_subprocess(void) : subprocess()
{
}

bool stlplus::backtick_subprocess::callback(void)
{
  for (;;)
  {
    std::string buffer;
...
bool stlplus::backtick_subprocess::spawn(const std::string& path, const stlplus::arg_vector& argv)
{
  return subprocess::spawn(path, argv, false, true, false);
}

bool stlplus::backtick_subprocess::spawn(const std::string& command_line)
{
  return subprocess::spawn(command_line, false, true, false);
}

std::vector<std::string> stlplus::backtick_subprocess::text(void) const
{
...
{
  stlplus::backtick_subprocess sub;
  sub.spawn(path, argv);
  return sub.text();
}
...
stlplus::async_subprocess::async_subprocess(void)
{
  pid.hProcess = 0;
  child_in = 0;
  child_out = 0;
...
void stlplus::async_subprocess::set_error(int e)
{
  err = e;
}

void stlplus::async_subprocess::add_variable(const std::string& name, const std::string& value)
{
  env.add(name, value);
}

bool stlplus::async_subprocess::remove_variable(const std::string& name)
{
  return env.remove(name);
}
...
bool stlplus::async_subprocess::callback(void)
{
  return true;
}
...
bool stlplus::async_subprocess::tick(void)
{
  bool result = true;
  if (!callback())
    kill();
...
bool stlplus::async_subprocess::kill(void)
{
  if (!pid.hProcess) return false;
  close_stdin();
  close_stdout();
...
int stlplus::async_subprocess::write_stdin (std::string& buffer)
{
  if (child_in == 0) return -1;
...
int stlplus::async_subprocess::read_stdout (std::string& buffer)
{
  if (child_out == 0) return -1;
...
int stlplus::async_subprocess::read_stderr (std::string& buffer)
{
  if (child_err == 0) return -1;
  // peek at the buffer to see how much data there is in the first place
  DWORD buffer_size = 0;
...
void stlplus::async_subprocess::close_stdin (void)
{
  if (child_in)
  {
    CloseHandle(child_in);
...
void stlplus::async_subprocess::close_stdout (void)
{
  if (child_out)
  {
    CloseHandle(child_out);
...
void stlplus::async_subprocess::close_stderr (void)
{
  if (child_err)
  {
    CloseHandle(child_err);
...
bool stlplus::async_subprocess::error(void) const
{
  return err != 0;
}

int stlplus::async_subprocess::error_number(void) const
{
  return err;
}
...
std::string stlplus::async_subprocess::error_text(void) const
{
  if (err == 0) return std::string();
  char* message;
  FormatMessage(FORMAT_MESSAGE_ALLOCATE_BUFFER|FORMAT_MESSAGE_FROM_SYSTEM|FORMAT_MESSAGE_IGNORE_INSERTS,
...
int stlplus::async_subprocess::exit_status(void) const
{
  return status;
}
