...
Like sprintf(), formats the message by appending to the std::string buffer
according to the formatting codes in the format string. The return int is
the number of characters generated by this call, i.e. the increase in the
...
dprintf calls within variable argument functions.
